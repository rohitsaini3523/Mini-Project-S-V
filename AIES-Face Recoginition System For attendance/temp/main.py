...
def contact():
    mess._show(title='Contact us', message="Please contact us on : '1032200897@gmail.com','1032201248@gmail.com' ")
...
def change_pass():
    ...
    global old
    old=tk.Entry(master,width=25 ,fg="white",relief='solid',font=('times', 12, ' bold '),show='*')
    old.place(x=180,y=10)
    lbl5 = tk.Label(master, text='   Enter New Password', bg='white', font=('times', 12, ' bold '))
    lbl5.place(x=10, y=45)
    global new
    new = tk.Entry(master, width=25, fg="white",relief='solid', font=('times', 12, ' bold '),show='*')
    new.place(x=180, y=45)
    lbl6 = tk.Label(master, text='Confirm New Password', bg='white', font=('times', 12, ' bold '))
    lbl6.place(x=10, y=80)
    global nnew
    nnew = tk.Entry(master, width=25, fg="white", relief='solid',font=('times', 12, ' bold '),show='*')
...
message3 = tk.Label(window, text="Class Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
