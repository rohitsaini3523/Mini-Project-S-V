...
<body style="padding:1%">
    <center>
        ...
        <div class="form" style="width:60% ;">
            <h1 style=" color:black; font-size: large;" id="heading">Update Employee Details </h1>
            <form name="myform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return validate_form()">
                ...
                <button type="button" class="btn" style="background-color:red;"><a href="admin_login.php" style="text-decoration:none;color:white;">Logout</a></button>
